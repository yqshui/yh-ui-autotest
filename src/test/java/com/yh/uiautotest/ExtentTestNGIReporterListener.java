...
public class ExtentTestNGIReporterListener implements IReporter {
    ...
    static String dataNow=format2.format(new Date());
    //生成的路径以及文件名
...
//        }
    ...
    private void init() {
        ...
        htmlReporter.config().setDocumentTitle("ui自动化测试");
        ...
        if (tests.size() > 0) {
            ...
            for (ITestResult result : treeSet) {
                ...
                if(name.length()>0){
                    ...
                    name = result.getMethod().getMethodName()+"描述："+result.getMethod().getDescription();
                }
                if(extenttest==null){
